...
public class RefundController {
    ...
    @GetMapping
    public ResponseEntity<List<RefundDto>> getAllRefundByCashier() throws Exception {
    ...
    public ResponseEntity<List<RefundDto>> getRefundByCashierAndDateRange(@PathVariable Long chashierId,
                                                                          @RequestParam
                                                                          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime startDate,
                                                                          @RequestParam
                                                                          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime endDate) throws Exception {
        List<RefundDto> refund = refundService.getRefundByCashierAndDateRange(chashierId,startDate,endDate);
        return  ResponseEntity.ok(refund);
    }
    ...
    public ResponseEntity<ApiResponse> deleteRefund(@PathVariable Long refundId) throws Exception {
        ...
        apiResponse.setMessage("Refund delete success");
